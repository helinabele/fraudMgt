...
describe('Director Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'director', component: DirectorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.directors?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to directorService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getDirectorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDirectorIdentifier).toHaveBeenCalledWith(entity);
